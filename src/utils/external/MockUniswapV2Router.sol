...
contract MockUniswapV2Router {
    ...
    function addLiquidityETH(address _addr,uint256 _uintMock1,uint256 _uintMock2,uint256 _collateralAmount,address _addr2,uint256 _timeStamp) external payable returns (uint256,uint256,uint256) {
        return(0,0,10 * 10**18);
    }
}
