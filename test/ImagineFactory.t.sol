...
contract TestImagineFactory is Test {
    ...
    function testMigrationSuccess() public {
        ...
        assertTrue(
            ...
            "readyForMigration must be change to ready for update"
        );
    ...
    function testSetTokenURI() public {
        ...
        string memory symbol = "TTK";
        string memory tokenURI = "test token uri";
        string memory newTokenURI = "new test token uri";
        ...
        vm.expectRevert(IImagineFactory.OnlyTokenCreator.selector);
        // // Try setting the URI invalid access (should fail)
